...
public class TCP_Receiver extends TCP_Receiver_ADT {
    ...
    int lastSequence = -1; // Used to record the current sequence number of the packet to be received. Note that the packet sequence number is not entirely accurate.
